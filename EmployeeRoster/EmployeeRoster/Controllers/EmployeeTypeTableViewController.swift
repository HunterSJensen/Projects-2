...
//  EmployeeRoster
//
//  Created by Hunter Jensen on 11/3/23.
//
...
protocol EmployeeTypeTableViewControllerDelegate: AnyObject {
    ...
    func employeeTypeTableViewController(_ controller:
       EmployeeTypeTableViewController, didSelect roomType:
       EmployeeType)
}
...
class EmployeeTypeTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let selectedRow = EmployeeType.allCases[indexPath.row]
        employeeType = selectedRow
        delegate?.employeeTypeTableViewController(self, didSelect: selectedRow)
